...
potionText={
	[222] = "",
	[223] = "",
	[224] = "약화와 강제 수면을 치료하고 6시간 동안 방지합니다.",
	[225] = "질병과 독을 치료하고 6시간 동안 방지합니다.",
	[226] = "저주와 마비를 치료하고 6시간 동안 방지합니다.",
	[227] = "공포와 광기를 치료하고 6시간 동안 방지합니다.",
	[228] = "6시간 동안 속도가 증가합니다.",
	[229] = "6시간 동안 근접 피해가 5 + (0.5 × 위력)만큼 증가합니다.",
	[230] = "6시간 동안 공격력이 5 + (0.5 × 위력)만큼 증가합니다.",
	[231] = "6시간 동안 보존과 방패(주문과 동일) 효과를 부여합니다.\n작동하려면 위력 20이 필요합니다.\n",
	[232] = "6시간 동안 명상 기술에 보너스를 부여합니다.",
	[233] = "6시간 동안 생명력을 재생합니다.",
	[234] = "6시간 동안 방어력이 5 + (0.5 × 위력)만큼 증가합니다.",
	[235] = "6시간 동안 익사 피해를 방지합니다.\n작동하려면 위력 20이 필요합니다.\n",
	[236] = "아이템의 내구성을 높여 파손에 더 잘 견디게 합니다.\n",
	[237] = "6시간 동안 마법 보호(주문과 동일) 효과를 5 + 물약 위력 10당 1만큼 부여합니다.\n위력 50 이상이면 죽음과 소멸도 방지합니다.\n",
	[238] = "물약 위력에 따라 마법이 부여되지 않은 아이템에 마법부여 효과 1개를 추가합니다.\n작동하려면 위력이 최소 20 필요합니다.\n",
	[239] = "석화를 치료하고 6시간 동안 석화를 방지합니다.\n작동하려면 위력 20이 필요합니다.\n",
	[240] = "6시간 동안 힘과 정확도가 10 + (1 × 위력)만큼 증가합니다.",
	[241] = "6시간 동안 지능과 성격이 10 + (1 × 위력)만큼 증가합니다.",
	[242] = "6시간 동안 인내력, 속도, 행운이 10 + (1 × 위력)만큼 증가합니다.",
	[243] = "무기에 무작위 2단계 원소 피해 마법부여를 추가합니다.\n작동하려면 위력 40이 필요합니다.\n",
	[244] = "마법이 부여되지 않은 무기에 '신속의' 속성을 추가합니다.\n작동하려면 위력 40이 필요합니다.\n",
	[245] = "신속 + 영웅심 + 축복 효과를 부여합니다.",
	[246] = "죽음과 소멸을 제외한 모든 상태 이상을 제거하고 6시간 동안 방지합니다.\n작동하려면 위력 40이 필요합니다.\n",
	[247] = "물약의 위력에 따라 생명력을 회복합니다.",
	[248] = "물약의 위력에 따라 주문력을 회복합니다.",
	[249] = "화염, 공기, 물, 대지 저항을 일시적으로 증가시킵니다. (어둠)",
	[250] = "정신 및 육체 저항을 일시적으로 증가시킵니다. (빛)",
	[251] = "방패 + 돌 피부 + 보존 효과를 부여합니다.",
	[252] = "물약 위력 50마다 힘과 정확도에 영구적으로 20을 추가합니다.\n이전에 얻은 보너스와 중첩되지 않습니다.\n",
	[253] = "물약 위력 50마다 지능과 지혜에 영구적으로 20을 추가합니다.\n이전에 얻은 보너스와 중첩되지 않습니다.\n",
	[254] = "물약 위력 50마다 인내력, 속도, 행운에 영구적으로 20을 추가합니다.\n이전에 얻은 보너스와 중첩되지 않습니다.\n",
	[255] = "무기에 무작위 3단계 원소 피해 마법부여를 영구적으로 추가합니다.\n작동하려면 위력 50이 필요합니다.\n",
...
evt.PotionEffects[95] = function(IsDrunk, t, Power)
	if t.Number<=151 or (t.Number>=803 and t.Number<=936) or (t.Number>=1603 and t.Number<=1736) then
		...
		if Game.ItemsTxt[t.Number].NotIdentifiedName==Game.ItemsTxt[t.Number+1].NotIdentifiedName then
			...
			if GetItemEquipStat(t)<=2 then --weapons
				local itemType=GetItemSkill(t)
				local itemSlot=GetItemEquipStat(t)
