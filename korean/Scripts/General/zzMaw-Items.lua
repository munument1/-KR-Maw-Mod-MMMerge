...
------------------------------------------
legendaryEffects={
	[11]="단일 대상 공격으로 몬스터를 처치하면 회복 시간이 절반으로 줄어듭니다",
	[12]="힘과 정확도 마법부여는 지력과 인격에 40%의 추가 보너스를 줍니다. 지력과 인격 마법부여는 힘과 정확도에 40%의 추가 보너스를 줍니다",
	[13]="몬스터가 유발하는 모든 상태 이상에 면역이 됩니다",
	[14]="치명타 확률이 10% 증가하며, 100%를 초과한 치명타 확률은 총 피해를 증가시킵니다",
	[15]="신성한 보호 (사망하는 대신 생명력 25%로 회복, 5분마다 한 번)",
	
	[16]="저항 기본 마법부여의 효과가 50% 증가합니다",
	
	[17]="공격이 몬스터의 현재 생명력 2%만큼 물리 피해를 줍니다(광역 공격, 다단히트 주문, 화살은 1%).\n피해량은 무기의 기본 공격 속도에 따라 증가하며, 주문은 승천에 따라 증가합니다.",
	[18]="받는 모든 피해가 10% 감소합니다",
	[19]="무기 마법부여 효과는 힘/지력/인격 중 가장 높은 수치에 따라 증가합니다",
	[20]="이 아이템의 기본 마법부여 효과가 50% 강해집니다",
	[21]="주변의 적 하나마다 근접 피해가 5% 증가합니다",
	[22]="주변의 적 하나마다 받는 피해가 3% 감소합니다",
	[23]="아군 엄호에 성공하면 자신의 생명력을 3% 회복합니다",
	[24]="몬스터를 처치하면 생명력과 마나를 10% 회복합니다",
	[25]="승천 기술 레벨이 10 증가합니다",
	[26]="무기 마법부여 효과가 치명타 피해를 줄 수 있습니다",
	
	[27]="흡수로 발생한 초과 회복량은 대신 가장 많이 다친 파티원을 회복합니다",
	[28]="방어구에서 얻는 방어력이 두 배가 됩니다",
	[29]="공격할 때마다 몬스터의 저항을 1 감소시킵니다",
	[30]="죽음/소멸 판정에 사용하는 생명력 임계값은 더 높은 경우 주문력에 마나 방패 효율을 곱한 값을 대신 사용합니다",
	[31]="흡수가 마나도 회복하지만 효과는 절반으로 감소합니다",
	[32]="버프가 마나 대신 생명력을 점유하며 생명력 계수를 대신 사용합니다.\n깨달음 보너스는 계속 적용됩니다.",
	[33]="근접 무기 기술이 10 증가합니다",
	[34]="초과 회복 시 마나를 돌려받습니다",
	[35]="초과 회복량의 절반만큼 회복 시간을 감소시킵니다",
}
...
function events.GameInitialized2()
	...
	itemStatName[14] = StrColor(153, 76, 0, "대지 저항")
	...
	itemStatName[22] = StrColor(255,255,153, "무기 전문가 기술")
	itemStatName[23] = StrColor(255,255,153, "회피 기술")
	itemStatName[24] = StrColor(255,255,153, "맨손 전투 기술")
...
function checktext(MaxCharges,bonus2,it)
	...
	bonus2txt={
		[1] =  " +" .. math.floor(bonusEffects[1].statModifier * mult) .. " 모든 저항.",
		[2] = " +" .. math.floor(bonusEffects[2].statModifier * mult) .. " 7대 능력치 전체.",
		[4] ="추가 " .. math.floor(6*enchantDamageMult*attackSpeedMult*legDmgMult) .. "-" .. math.floor(8*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 냉기 피해.",
		[5] ="추가 " .. math.floor(18*enchantDamageMult*attackSpeedMult*legDmgMult) .. "-" .. math.floor(24*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 냉기 피해.",
		[6] ="추가 " .. math.floor(36*enchantDamageMult*attackSpeedMult*legDmgMult) .. "-" .. math.floor(48*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 냉기 피해.",
		[7] ="추가 " .. math.floor(4*enchantDamageMult*attackSpeedMult*legDmgMult) .. "-" .. math.floor(10*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 전기 피해.",
		[8] ="추가 " .. math.floor(12*enchantDamageMult*attackSpeedMult*legDmgMult) .. "-" .. math.floor(30*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 전기 피해.",
		[9] ="추가 " .. math.floor(24*enchantDamageMult*attackSpeedMult*legDmgMult) .. "-" .. math.floor(60*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 전기 피해.",
		[10] ="추가 " .. math.floor(2*enchantDamageMult*attackSpeedMult*legDmgMult) .. "-" .. math.floor(12*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 화염 피해.",
		[11] ="추가 " .. math.floor(6*enchantDamageMult*attackSpeedMult*legDmgMult) .. "-" .. math.floor(36*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 화염 피해.",
		[12] ="추가 " .. math.floor(12*enchantDamageMult*attackSpeedMult*legDmgMult) .. "-" .. math.floor(72*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 화염 피해.",
		[13] ="추가 " .. math.floor(12*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 육체 피해.",
		[14] ="추가 " .. math.floor(24*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 육체 피해.",
		[15] ="추가 " .. math.floor(48*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 육체 피해.",
		--spell enchants
		[26] = "공기 마법 기술 +" .. math.floor(MaxCharges/4)+5,
		[27] = "육체 마법 기술 +" .. math.floor(MaxCharges/4)+5,
		[28] = "어둠 마법 기술 +" .. math.floor(MaxCharges/4)+5,
		[29] = "대지 마법 기술 +" .. math.floor(MaxCharges/4)+5,
		[30] = "화염 마법 기술 +" .. math.floor(MaxCharges/4)+5,
		[31] = "빛 마법 기술 +" .. math.floor(MaxCharges/4)+5,
		[32] = "정신 마법 기술 +" .. math.floor(MaxCharges/4)+5,
		[33] = "영혼 마법 기술 +" .. math.floor(MaxCharges/4)+5,
		[34] = "물 마법 기술 +" .. math.floor(MaxCharges/4)+5,
		--stats enchants
		[38] = "명상 기술 +" .. math.floor(MaxCharges*3/20)+3,
		[39] = "추가 " .. math.floor(40*enchantDamageMult*attackSpeedMult*legDmgMult) .. "-" .. math.floor(80*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 주문 피해, +" .. math.floor(bonusEffects[46].statModifier * mult).. " 지능 및 성격.",
		[40] = "주문으로 대상의 생명력을 흡수하고 주문 시전 속도가 증가합니다. (보조 손에 장비하면 적용되지 않습니다.)",
		[42] = " +" .. math.floor(bonusEffects[42].statModifier * mult) .. " 7대 능력치, 생명력, 주문력, 방어력, 저항.",
		[43] = " +" .. math.floor(bonusEffects[43].statModifier * mult) .. " 인내력, 방어력, 생명력.",
		[44] = " +" .. math.floor(bonusEffects[44].statModifier * mult) .. " 생명력 및 지속 생명력 재생.",
		[45] = " +" .. math.floor(bonusEffects[45].statModifier * mult) .. " 속도 및 정확도.",
		[46] = "추가 " .. math.floor(40*enchantDamageMult*attackSpeedMult*legDmgMult) .. "-" .. math.floor(80*enchantDamageMult*attackSpeedMult*legDmgMult) .. " 화염 피해 (" .. weaponType .. " 공격), +" .. math.floor(bonusEffects[46].statModifier * mult).. " 힘.",
		[47] = " +" .. math.floor(bonusEffects[47].statModifier * mult) .. " 주문력 및 명상 기술 +" .. math.floor(MaxCharges*3/20)+3,
		[48] = " +" .. math.floor(bonusEffects[48].statModifier[1] * mult) .. " 인내력 및" .. " +" .. math.floor(bonusEffects[48].statModifier[2] * mult).. " 방어력.",
		[49] = " +" .. math.floor(bonusEffects[49].statModifier * mult) .. " 지능 및 행운.",
		[50] = " +" .. math.floor(bonusEffects[50].statModifier * mult) .. " 화염 저항 및 지속 생명력 재생.",
		[51] = " +" .. math.floor(bonusEffects[51].statModifier * mult) .. " 주문력, 속도, 지능.",
		[52] = " +" .. math.floor(bonusEffects[52].statModifier * mult) .. " 인내력 및 정확도.",
		[53] = " +" .. math.floor(bonusEffects[53].statModifier * mult) .. " 힘 및 성격.",
		[54] = " +" .. math.floor(bonusEffects[54].statModifier * mult) .. " 인내력 및 지속 생명력 재생.",
		[55] = " +" .. math.floor(bonusEffects[55].statModifier * mult) .. " 행운 및 명상 기술 +" .. math.floor(MaxCharges*3/20)+3,
		[56] = " +" .. math.floor(bonusEffects[56].statModifier * mult) .. " 힘 및 인내력.",
		[57] = " +" .. math.floor(bonusEffects[57].statModifier * mult) .. " 지능 및 성격.",
		[66] = "생명력 재생 및 명상 기술 +" .. math.floor(MaxCharges*3/20)+3,
		--hybrids enchants 
		[74] = " +" .. math.floor(bonusEffects[74].statModifier * mult) .. " 성격 및 정확도.",
		[75] = " +" .. math.floor(bonusEffects[75].statModifier * mult) .. " 지능 및 힘.",
		[76] = " +" .. math.floor(bonusEffects[76].statModifier * mult) .. " 지능 및 정확도.",
		[77] = " +" .. math.floor(bonusEffects[77].statModifier * mult) .. " 힘, 지능 및 성격.",
		[78] = " +" .. math.floor(bonusEffects[78].statModifier * mult) .. " 원소 저항.",
		[79] = " +" .. math.floor(bonusEffects[79].statModifier * mult) .. " 육체 및 정신 저항.",
		[80] = " +" .. math.floor(bonusEffects[80].statModifier * mult) .. " 7대 능력치, 생명력, 주문력, 방어력, 저항.",
	}
